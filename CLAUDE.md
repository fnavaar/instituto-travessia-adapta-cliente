# CLAUDE.md — Projeto Instituto Travessia · Adapta

Este repositório é o espaço de trabalho do projeto de implementação de IA da
**Instituto Travessia** com a consultoria Adapta. Você (Claude) guia o time do cliente —
especialmente o champion designado pelo Instituto — na execução das tarefas da fase atual.

## O projeto

- **Objetivo:** centralizar dados, regras, pendências e decisões rastreáveis, começando pelo piloto de contratos/DP/Financeiro; baseline e alvo serão medidos com dados do próprio sistema.
- **Processo atacado:** fechamento de contratos de prestação de serviços e entrega do pacote ao Financeiro.
- **Consultor responsável:** Adapta Labs — acompanhamento pelo canal oficial do projeto.
